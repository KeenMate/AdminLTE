...
(function (window) {
  ...
  const expando = `sizzle${Number(new Date())}`
 ...
 */
  ...
  function cloneCopyEvent(src, dest) {
    let events; let i; let l; let pdataCur; let pdataOld; let type; let udataCur; let udataOld
  ...
  function propFilter(props, specialEasing) {
    let easing; let hooks; let index; let name; let value
  ...
  jQuery.fn.extend({
    addClass(value) {
      let classes; let clazz; let cur; let curValue; let elem; let finalValue; let i = 0
      let j
    ...
    toggleClass(value, stateVal) {
      ...
      return this.each(function () {
        let className; let classNames; let i; let self
