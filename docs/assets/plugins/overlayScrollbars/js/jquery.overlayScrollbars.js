...
(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['jquery'], (framework) => factory(global, global.document, undefined, framework))
  ...
  (window, document, undefined, framework) => {
    ...
    const MATH = Math
    const JQUERY = framework
    const EASING = framework.easing
